...
![Publish](https://github.com/Judahh/elasticPersistence/workflows/Publish/badge.svg)
[![npm version](https://badge.fury.io/js/@flexiblepersistence%2elastic.svg)](https://badge.fury.io/js/@flexiblepersistence/elastic)
[![npm downloads](https://img.shields.io/npm/dt/@flexiblepersistence/elastic.svg)](https://img.shields.io/npm/dt/@flexiblepersistence/elastic.svg)

A Elastic implementation for Flexible Persistence's PersistenceAdapter
...
```bash
$ npm install @flexiblepersistence/elastic
```

or

```bash
$ yarn add @flexiblepersistence/elastic
```
...
[List of all contributors](https://github.com/Judahh/elasticPersistence/graphs/contributors)
